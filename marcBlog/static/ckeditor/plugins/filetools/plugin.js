...
(function () {
        ...
        beforeInit: function (editor) {
            ...
            editor.on('fileUploadResponse', function (evt) {
                ...
                try {
                    ...
                    CKEDITOR.warn('filetools-response-errors', {responseText: xhr.responseText});
     ...
     * {@link #event-uploaded}, {@link #event-errors} and {@link #event-abort}. These events are called only once,
     ...
     * * `errors` &ndash; The process stops because of an errors, more details are available in the {@link #message} property.
    ...
    /**
     * The errors message or additional information received from the server.
     *
     * @readonly
     ...
     * * If the {@link #status} is `loaded`, `uploaded`, `errors` or `abort`, this method will do nothing.
     *
     * @method abort
     */
    ...
    FileLoader.prototype = {
        ...
        attachRequestListeners: function () {
            ...
            function onError() {
                // Prevent changing status twice, when XHR.errors and XHR.upload.onerror could be called together.
         ...
         * `loaded`, `uploaded`, `errors` or `abort`.
         *
        ...
        /**
         * Event fired when the {@link #status} changes to `errors`. It will be fired once for the `FileLoader`.
         *
         * @event error
         */
